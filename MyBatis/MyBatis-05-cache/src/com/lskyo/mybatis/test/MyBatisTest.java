...
import com.lskyo.mybatis.dao.EmployeeMapperDynamicSQL;
...
//			Employee employee = mapper.getEmpByIdAndLastName(5, "jerry");
	...
	public void test13() throws IOException {
		...
		try{
			EmployeeMapperDynamicSQL mapper = openSession.getMapper(EmployeeMapperDynamicSQL.class);
			Employee employee = new Employee(null, null, "tom@qq.com", null, null);
	...
	public void test14() throws IOException {
		...
		try{
			EmployeeMapperDynamicSQL mapper = openSession.getMapper(EmployeeMapperDynamicSQL.class);
			Employee employee = new Employee(5, "Admin", null, null, null);
			boolean result = mapper.updateEmp(employee);
			System.out.println(result);
			openSession.commit();
	...
	public void test15() throws IOException {
		...
		try{
			EmployeeMapperDynamicSQL mapper = openSession.getMapper(EmployeeMapperDynamicSQL.class);
			List<Employee> list = mapper.getEmpsByConditionForeach(Arrays.asList(5,6,7));
			for (Employee employee : list) {
				System.out.println(employee);
			}
	...
	/**
	 * 测试 _databaseId 和  _parameter 内置参数
	 * @throws IOException
	 */
	@Test
	public void test16() throws IOException {
		...
		try{
			...
			param.setLastName("%o%");
			List<Employee> list = mapper.getEmpsTestInnerParameter(param);
			for (Employee employee : list) {
				System.out.println(employee);
			}
